...
class Api {
    ...
    async getCustomers({ page, limit, sortBy, search }) {
        const response = await axiosInstance.get(`/customers?page=${page}&limit=${limit}&search=${search}&sortBy=${sortBy}`);

        return response;
    }
    async getOTP({ page, limit, sortBy, search }) {
        const response = await axiosInstance.get(`/customers/otp?page=${page}&limit=${limit}&search=${search}&sortBy=${sortBy}`);
    ...
    async getUsers({ page, limit, sortBy, search }) {
        return axiosInstance
            .get(`/users?page=${page}&limit=${limit}&search=${search}&sortBy=${sortBy}`)
    ...
    async editUsers({ user_id, name, email, password_show, phone, address, actions }) {
        const requestData = {
            user_id,
            name,
            email,
    ...
    async getNorifications({ page, limit, sortBy, search }) {
        const response = await axiosInstance.get(`/notifications?page=${page}&limit=${limit}&sortBy=${sortBy}&search=${search}`);
    ...
    async removeNorifications(id) {
        const response = await axiosInstance.delete(`/notifications/notification_id/${id}`);
    ...
    async addCountries({ name, en_name, code, phone_code }) {
        ...
        const response = await axiosInstance
            .post(`/countries`, requestData)
            return response;
    }
    async editCountries({ country_id, name, en_name, code, phone_code, is_active }) {
        const requestData = {
            country_id,
            name,
            en_name,
    ...
    async getCities({ page, limit, sortBy, search, country_id }) {
        const response = await axiosInstance
            .get(`/cities?page=${page}&limit=${limit}&sortBy=${sortBy}&search=${search}&country_id=${country_id}`);
            return response;
    }
    ...
    async addCities({ name, en_name, code, country_id }) {
        ...
        const response = await axiosInstance
            .post(`/cities`, requestData)
            return response;
    }
    async editCities({ city_id, country_id, name, en_name, code, is_active }) {
        const requestData = {
            city_id, country_id, name, en_name, code, is_active
        };
    ...
    async getAirports({ page, limit, sortBy, search, country_id }) {
        const response = await axiosInstance
            .get(`/airports?page=${page}&limit=${limit}&sortBy=${sortBy}&search=${search}&city_id=${country_id}`);
            return response;
    }
    async getAirportsCountries({ page, limit, sortBy, search, country_id, city_id }) {
        const response = await axiosInstance
            .get(`/airports/country_id/${country_id}?page=${page}&limit=${limit}&search=${search}&sortBy=${sortBy}&city_id=${city_id}`);
            return response;
    }
    async getCitiesAll() {
        const response = await axiosInstance
    ...
    async addAirports({ name, en_name, code, city_id }) {
        ...
        const response = await axiosInstance
            .post(`/airports`, requestData)
            return response;
    }
    async editAirports({ airport_id, city_id, name, en_name, code, is_active }) {
        const requestData = {
            airport_id, city_id, name, en_name, code, is_active
        };
    ...
    async getAirlines({ page, limit, sortBy, search }) {
        const response = await axiosInstance
            .get(`/airlines?page=${page}&limit=${limit}&sortBy=${sortBy}&search=${search}`);
            return response;
    }
    async addAirlines({ name, en_name, code, logo }) {
        ...
        const response = await axiosInstance
            .post(`/airlines`, requestData)
            return response;
    }
    async editAirlines({ airline_id, old_logo, name, en_name, code, is_active, logo }) {
        const requestData = {
            airline_id, old_logo, name, en_name, code, is_active, logo
        };
    ...
    async getFlights({ page, limit, sortBy, search }) {
        const response = await axiosInstance
            .get(`/flights?page=${page}&limit=${limit}&sortBy=${sortBy}&search=${search}`);
            return response;
    }
    ...
    async addFlights({ number, airline_id, departure_airport, arrival_airport, departure_date, arrival_date, seats, child_price, adult_price, infant_price }) {
        const requestData = {
            number, airline_id, departure_airport, arrival_airport, departure_date, arrival_date, seats, child_price, adult_price, infant_price
        };
        const response = await axiosInstance
            .post(`/flights`, requestData)
            return response;
    }
    async editFlights({ flight_id, number, airline_id, departure_airport, arrival_airport, departure_date, arrival_date, seats, child_price, adult_price, infant_price, is_active }) {
        const requestData = {
            flight_id, number, airline_id, departure_airport, arrival_airport, departure_date, arrival_date, seats, child_price, adult_price, infant_price, is_active
        };
