...
//
var sentlength = MailItem.filter(item => item.type === 'sent').length;
...
const MailMenu = [
    {
        ...
        group: "email",
        icon: "mdi-email",
        to: { path: "/apps/email/inbox" },
        chip: MailItem.length 
    },
    {
        title: "Sent",
        group: "email",
        icon: "mdi-send",
        to: { path: "/apps/email/sent" },
        chip: sentlength
    },
    {
        title: "Starred",
    ...
    },
    {
        ...
        iconColor: "success",
        title: "Promotional",
        to: { path: "/apps/email/0/Promotion" },
        iconSize: "small"
    },
    {
        icon: "mdi-checkbox-blank-circle",
...
const getMailByTag = tag => {
    return tag ===  undefined ? MailItem : MailItem.filter(x => x.tag === tag)
}
export { getMail, MailMenu, getMailById, getMailByType, getMailByTag }
=======
import * as User from "./user"
