<template>
  <v-container fluid class="pa-0 mail-reply" id="mailReply">
    ...
    <!-- Email Detail Card -->
    <!-- ------------------------------------------------------------------------ -->
    <v-card class="mail-reply--layout" elevation="0" v-if="isSelected">
      <!-- Detail Header -->
      ...
      <v-toolbar-title class="pa-4 pt-6">
        <v-avatar size="32">
          <img :src="require('@/assets/images/users' + mail.from.avatar)" />
        </v-avatar>
    ...
    <v-card elevation="0" v-else class="selectmailbox">
