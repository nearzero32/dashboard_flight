  ...
  <v-container fluid class="down-top-padding">
        ...
        <v-card>
          <v-card-title>
            <v-btn color="primary" text class="ml-auto" @click="dialog = true">
              <vIcon class="mr-2">mdi-plus</vIcon>أضافة مركز جديد
            </v-btn>
    ...
    <div class="text-center mt-4 mt-sm-0">
      <v-dialog v-model="dialog" activator="parent">
        <v-card>
          <v-card>
            <v-card-title class="text-h5">أضافة مركز جديد</v-card-title>
            <v-divider></v-divider>
            <!----Account Details---->
...
export default {
  data: () => ({
    ...
    Rules: {
      account_nameRules: [(v) => !!v || "يرجى إدخال اسم المركز"],
      phoneRules: [
        (v) => !!v || "يرجى إدخال رقم الهاتف",
        (v) =>
          (v && /^[0-9]{11}$/.test(v)) || "يرجى إدخال رقم هاتف صحيح (11 أرقام)",
      ],
      addressRules: [(v) => !!v || "يرجى إدخال عنوان المركز"],
    },
    // add
    // edit
