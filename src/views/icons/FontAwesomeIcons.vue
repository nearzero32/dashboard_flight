  ...
  <v-container fluid class="down-top-padding">
    ...
    <v-card class="mb-7">
      <v-card-text class="pa-5">
        <h3 class="title blue-grey--text text--darken-2 font-weight-regular">Solid Icons</h3>
        <v-row>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-address-book"></i> fas fa-address-book
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-address-card"></i> fas fa-address-card
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-adjust"></i> fas fa-adjust
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-align-center"></i> fas fa-align-center
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-align-justify"></i> fas fa-align-justify
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-align-left"></i> fas fa-align-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-align-right"></i> fas fa-align-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-american-sign-language-interpreting"></i> fas fa-american-sign-language-interpreting
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-anchor"></i> fas fa-anchor
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-angle-double-down"></i> fas fa-angle-double-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-angle-double-left"></i> fas fa-angle-double-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-angle-double-right"></i> fas fa-angle-double-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-angle-double-up"></i> fas fa-angle-double-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-angle-down"></i> fas fa-angle-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-angle-left"></i> fas fa-angle-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-angle-right"></i> fas fa-angle-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-alt-circle-down"></i> fas fa-arrow-alt-circle-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-alt-circle-left"></i> fas fa-arrow-alt-circle-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-alt-circle-right"></i> fas fa-arrow-alt-circle-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-alt-circle-up"></i> fas fa-arrow-alt-circle-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-circle-down"></i> fas fa-arrow-circle-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-circle-left"></i> fas fa-arrow-circle-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-circle-right"></i> fas fa-arrow-circle-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-circle-up"></i> fas fa-arrow-circle-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-down"></i> fas fa-arrow-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-left"></i> fas fa-arrow-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-right"></i> fas fa-arrow-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrow-up"></i> fas fa-arrow-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrows-alt"></i> fas fa-arrows-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrows-alt-h"></i> fas fa-arrows-alt-h
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-arrows-alt-v"></i> fas fa-arrows-alt-v
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-assistive-listening-systems"></i> fas fa-assistive-listening-systems
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-audio-description"></i> fas fa-audio-tion
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-backward"></i> fas fa-backward
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-balance-scale"></i> fas fa-balance-scale
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-baseball-ball"></i> fas fa-baseball-ball
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-basketball-ball"></i> fas fa-basketba
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-bath"></i> fas fa-bath
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-battery-empty"></i> fas fa-battery-empty
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-battery-full"></i> fas fa-battery-full
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-battery-half"></i> fas fa-battery-half
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-battery-quarter"></i> fas fa-battery-quarter
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-battery-three-quarters"></i> fas fa-battery-three-quarters
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-bell-slash"></i> fas fa-bell-slash
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-bicycle"></i> fas fa-bicycle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-binoculars"></i> fas fa-binoculars
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-birthday-cake"></i> fas fa-birthday-cake
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-bowling-ball"></i> fas fa-bowling-ball
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-briefcase-medical"></i> fas fa-briefcical
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-calculator"></i> fas fa-calculator
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-calendar"></i> fas fa-calendar
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-calendar-alt"></i> fas fa-calendar-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-calendar-check"></i> fas fa-calendar-check
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-calendar-minus"></i> fas fa-calendar-minus
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-calendar-plus"></i> fas fa-calendar-plus
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-calendar-times"></i> fas fa-calendar-times
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-camera"></i> fas fa-camera
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-camera-retro"></i> fas fa-camera-retro
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-caret-down"></i> fas fa-caret-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-caret-left"></i> fas fa-caret-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-caret-right"></i> fas fa-caret-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-caret-square-down"></i> fas fa-caret-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-caret-square-left"></i> fas fa-caret-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-caret-square-right"></i> fas fa-caret-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-caret-square-up"></i> fas fa-caret-sq
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-caret-up"></i> fas fa-caret-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-cart-arrow-down"></i> fas fa-cart-arr
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-cart-plus"></i> fas fa-cart-plus
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-certificate"></i> fas fa-certificate
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chart-area"></i> fas fa-chart-area
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chart-bar"></i> fas fa-chart-bar
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chart-line"></i> fas fa-chart-line
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-check-circle"></i> fas fa-check-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-check-square"></i> fas fa-check-square
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chess"></i> fas fa-chess
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chess-bishop"></i> fas fa-chess-bishop
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chess-board"></i> fas fa-chess-board
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chess-king"></i> fas fa-chess-king
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chess-knight"></i> fas fa-chess-knight
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chess-pawn"></i> fas fa-chess-pawn
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chess-queen"></i> fas fa-chess-queen
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chess-rook"></i> fas fa-chess-rook
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chevron-circle-down"></i> fas fa-chevron-circle-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chevron-circle-left"></i> fas fa-chevron-circle-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chevron-circle-right"></i> fas fa-chevron-circle-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chevron-circle-up"></i> fas fa-chevroe-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chevron-down"></i> fas fa-chevron-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chevron-left"></i> fas fa-chevron-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chevron-right"></i> fas fa-chevron-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-chevron-up"></i> fas fa-chevron-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-circle-notch"></i> fas fa-circle-notch
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-clipboard"></i> fas fa-clipboard
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-clipboard-check"></i> fas fa-clipboard-check
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-clipboard-list"></i> fas fa-clipboard-list
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-closed-captioning"></i> fas fa-closedning
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-cloud"></i> fas fa-cloud
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-cloud-download-alt"></i> fas fa-cloudad-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-cloud-upload-alt"></i> fas fa-cloud-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-code"></i> fas fa-code
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-code-branch"></i> fas fa-code-branch
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-comment-alt"></i> fas fa-comment-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-comment-dots"></i> fas fa-comment-dots
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-comment-slash"></i> fas fa-comment-slash
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-credit-card"></i> fas fa-credit-card
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-crop"></i> fas fa-crop
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-crosshairs"></i> fas fa-crosshairs
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-dollar-sign"></i> fas fa-dollar-sign
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-dolly"></i> fas fa-dolly
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-dolly-flatbed"></i> fas fa-dolly-flatbed
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-donate"></i> fas fa-donate
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-dot-circle"></i> fas fa-dot-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-ellipsis-h"></i> fas fa-ellipsis-h
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-ellipsis-v"></i> fas fa-ellipsis-v
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-envelope"></i> fas fa-envelope
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-envelope-open"></i> fas fa-envelope-open
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-envelope-square"></i> fas fa-envelope-square
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-exchange-alt"></i> fas fa-exchange-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-exclamation"></i> fas fa-exclamation
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-exclamation-circle"></i> fas fa-exclamation-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-exclamation-triangle"></i> fas fa-exclamation-triangle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-expand"></i> fas fa-expand
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-expand-arrows-alt"></i> fas fa-expand-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-external-link-alt"></i> fas fa-external-link-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-external-link-square-alt"></i> fas fa-external-link-square-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-eye"></i> fas fa-eye
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-eye-dropper"></i> fas fa-eye-dropper
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-eye-slash"></i> fas fa-eye-slash
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-fast-backward"></i> fas fa-fast-backward
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-fast-forward"></i> fas fa-fast-forward
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-fighter-jet"></i> fas fa-fighter-jet
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-file-archive"></i> fas fa-file-archive
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-file-audio"></i> fas fa-file-audio
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-file-code"></i> fas fa-file-code
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-file-excel"></i> fas fa-file-excel
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-file-image"></i> fas fa-file-image
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-file-medical"></i> fas fa-file-medical
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-file-medical-alt"></i> fas fa-file-medical-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-file-pdf"></i> fas fa-file-pdf
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-file-powerpoint"></i> fas fa-file-pow
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-file-video"></i> fas fa-file-video
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-fire-extinguisher"></i> fas fa-fire-extinguisher
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-flag-checkered"></i> fas fa-flag-checkered
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-folder-open"></i> fas fa-folder-open
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-font"></i> fas fa-font
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-football-ball"></i> fas fa-football-ball
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-genderless"></i> fas fa-genderless
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-gift"></i> fas fa-gift
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-glass-martini"></i> fas fa-glass-martini
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-graduation-cap"></i> fas fa-graduation-cap
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-h-square"></i> fas fa-h-square
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-holding"></i> fas fa-hand-holding
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-holding-heart"></i> fas fa-hand-holding-heart
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-holding-usd"></i> fas fa-hand-holding-usd
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-lizard"></i> fas fa-hand-lizard
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-paper"></i> fas fa-hand-paper
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-peace"></i> fas fa-hand-peace
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-point-down"></i> fas fa-hand-point-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-point-left"></i> fas fa-hand-point-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-point-right"></i> fas fa-hand-point-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-point-up"></i> fas fa-hand-point-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-pointer"></i> fas fa-hand-pointer
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-rock"></i> fas fa-hand-rock
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-scissors"></i> fas fa-hand-scissors
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hand-spock"></i> fas fa-hand-spock
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hands"></i> fas fa-hands
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hands-helping"></i> fas fa-hands-helping
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-headphones"></i> fas fa-headphones
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hockey-puck"></i> fas fa-hockey-puck
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hospital-alt"></i> fas fa-hospital-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hospital-symbol"></i> fas fa-hospital
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hourglass"></i> fas fa-hourglass
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hourglass-end"></i> fas fa-hourglass-end
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hourglass-half"></i> fas fa-hourglass-half
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-hourglass-start"></i> fas fa-hourglass-start
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-id-card-alt"></i> fas fa-id-card-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-info-circle"></i> fas fa-info-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-level-down-alt"></i> fas fa-level-down-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-level-up-alt"></i> fas fa-level-up-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-location-arrow"></i> fas fa-location-arrow
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-long-arrow-alt-down"></i> fas fa-long-arrow-alt-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-long-arrow-alt-left"></i> fas fa-long-arrow-alt-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-long-arrow-alt-right"></i> fas fa-long-arrow-alt-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-long-arrow-alt-up"></i> fas fa-long-arrow-alt-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-low-vision"></i> fas fa-low-vision
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-map-marker"></i> fas fa-map-marker
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-map-marker-alt"></i> fas fa-map-marker-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-mars-double"></i> fas fa-mars-double
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-mars-stroke"></i> fas fa-mars-stroke
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-mars-stroke-h"></i> fas fa-mars-stroke-h
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-mars-stroke-v"></i> fas fa-mars-stroke-v
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-microphone"></i> fas fa-microphone
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-microphone-slash"></i> fas fa-microphone-slash
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-minus"></i> fas fa-minus
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-minus-circle"></i> fas fa-minus-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-minus-square"></i> fas fa-minus-square
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-mobile"></i> fas fa-mobile
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-mobile-alt"></i> fas fa-mobile-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-money-bill-alt"></i> fas money-bill-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-moon"></i> fas fa-moon
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-motorcycle"></i> fas fa-motorcycle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-mouse-pointer"></i> fas fa-mouse-pointer
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-notes-medical"></i> fas fa-notes-medical
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-object-group"></i> fas fa-object-group
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-object-ungroup"></i> fas fa-object-ungroup
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-outdent"></i> fas fa-outdent
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-paint-brush"></i> fas fa-paint-brush
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-pallet"></i> fas fa-pallet
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-paper-plane"></i> fas fa-paper-plane
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-paperclip"></i> fas fa-paperclip
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-parachute-box"></i> fas fa-parachute-box
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-pause-circle"></i> fas pause-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-paw"></i> fas fa-fa-paw
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-pen-square"></i> fas fa-pen-square
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-pencil-alt"></i> fas fa-pencil-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-people-carry"></i> fas fa-people-carry
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-phone-slash"></i> fas fa-phone-slash
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-phone-square"></i> fas fa-phone-square
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-phone-volume"></i> fas fa-phone-volume
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-piggy-bank"></i> fas fa-piggy-bank
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-play-circle"></i> fas fa-play-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-plus-circle"></i> fas fa-plus-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-plus-square"></i> fas fa-plus-square
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-pound-sign"></i> fas fa-pound-sign
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-power-off"></i> fas fa-power-off
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-prescription-bottle"></i> fas fa-prescription-bottle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-prescription-bottle-alt"></i> fas fa-prescription-bottle-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-print"></i> fas fa-print
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-procedures"></i> fas fa-procedures
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-puzzle-piece"></i> fas fa-puzzle-piece
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-question-circle"></i> fas fa-question
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-quidditch"></i> fas fa-quidditch
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-quote-left"></i> fas fa-quote-left
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-quote-right"></i> fas fa-quote-right
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-registered"></i> fas fa-registered
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-rss-square"></i> fas fa-rss-square
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-ruble-sign"></i> fas fa-ruble-sign
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-rupee-sign"></i> fas fa-rupee-sign
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-search-minus"></i> fas fa-search-minus
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-search-plus"></i> fas fa-search-plus
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-share-alt-square"></i> fas fa-share-alt-square
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-share-square"></i> fas fa-share-square
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-shekel-sign"></i> fas fa-shekel-sign
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-shield-alt"></i> fas fa-shield-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-ship"></i> fas fa-ship
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-shipping-fast"></i> fas fa-shipping-fast
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-shopping-bag"></i> fas fa-shopping-bag
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-shopping-basket"></i> fas fa-shopping-basket
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-shopping-cart"></i> fas fa-shopping-cart
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sign-in-alt"></i> fas fa-sign-in-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sign-language"></i> fas fa-sign-language
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sign-out-alt"></i> fas fa-sign-out-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sort-alpha-down"></i> fas fa-alpha-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sort-alpha-up"></i> fas fa-sort-alpha-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sort-amount-down"></i> fas fa-sort-amount-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sort-amount-up"></i> fas fa-sort-amount-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sort-down"></i> fas fa-sort-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sort-numeric-down"></i> fas fa-sort-numeric-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sort-numeric-up"></i> fas fa-sort-numeric-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sort-up"></i> fas fa-sort-up
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-space-shuttle"></i> fas fa-space-shuttle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-square-full"></i> fas fa-square-full
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-step-backward"></i> fas fa-step-backward
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-step-forward"></i> fas fa-step-forward
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-stethoscope"></i> fas fa-stethoscope
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-sticky-note"></i> fas fa-sticky-note
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-stop"></i> fas fa-stop
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-stop-circle"></i> fas fa-stop-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-stopwatch"></i> fas fa-stopwatch
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-street-view"></i> fas fa-street-view
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-strikethrough"></i> fas fa-strikethrough
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-superscript"></i> fas fa-superscript
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-table-tennis"></i> fas fa-table-tennis
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-tablet"></i> fas fa-tablet
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-tablet-alt"></i> fas fa-tablet-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-tablets"></i> fas fa-tablets
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-tachometer-alt"></i> fas fa-tachometer-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-text-height"></i> fas fa-text-height
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-text-width"></i> fas fa-text-width
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-thermometer"></i> fas fa-thermometer
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-thermometer-empty"></i> fas fa-thermometer-empty
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-thermometer-full"></i> fas fa-thermometer-full
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-thermometer-half"></i> fas fa-thermometer-half
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-thermometer-quarter"></i> fas fa-thermometer-quarter
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-thermometer-three-quarters"></i> fas fa-thermometer-three-quarters
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-thumbs-down"></i> fas fa-thumbs-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-ticket-alt"></i> fas fa-ticket-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-times"></i> fas fa-times
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-times-circle"></i> fas fa-times-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-tint"></i> fas fa-tint
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-toggle-off"></i> fas fa-toggle-off
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-transgender"></i> fas fa-transgender
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-transgender-alt"></i> fas fa-transgen
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-truck-loading"></i> fas fa-truck-loading
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-truck-moving"></i> fas fa-truck-moving
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-universal-access"></i> fas fa-universal-access
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-university"></i> fas fa-university
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-unlock-alt"></i> fas fa-unlock-alt
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-user-circle"></i> fas fa-user-circle
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-user-secret"></i> fas fa-user-secret
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-user-times"></i> fas fa-user-times
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-users"></i> fas fa-users
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-utensil-spoon"></i> fas fa-utensil-spoon
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-venus-double"></i> fas fa-venus-double
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-venus-mars"></i> fas fa-venus-mars
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-video-slash"></i> fas fa-video-slash
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-volleyball-ball"></i> fas fa-volleyba
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-volume-down"></i> fas fa-volume-down
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-volume-off"></i> fas fa-volume-off
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
          ...
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-wheelchair"></i> fas fa-wheelchair
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-wifi"></i> fas fa-wifi
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-window-close"></i> fas fa-window-close
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-window-maximize"></i> fas fa-window-maximize
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-window-minimize"></i> fas fa-window-minimize
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-window-restore"></i> fas fa-window-restore
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
            <i class="mr-2 text-truncate fas fa-wine-glass"></i> fas fa-wine-glass
          </v-col>
          <v-col cols="12" lg="4" class="my-1">
    ...
    <v-card class="mb-7">
      <v-card-text class="pa-5">
        <h3 class="title blue-grey--text text--darken-2 font-weight-regular">Regular Icons</h3>
        <v-row>
          <v-col cols="12" lg="4" class="my-1">
    ...
    <v-card class="mb-7">
      <v-card-text class="pa-5">
        <h3 class="title blue-grey--text text--darken-2 font-weight-regular">Brand Icons</h3>
        <v-row>
          <v-col cols="12" lg="4" class="my-1">
