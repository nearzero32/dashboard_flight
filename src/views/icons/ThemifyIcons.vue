      ...
      <v-col cols="12">
        <v-card class="mb-7">
          <v-card-text class="pa-5">
            <h3 class="card-title d-flex">Arrows & Direction Icons</h3>
            <v-row>
        ...
        <v-card class="mb-7">
          <v-card-text class="pa-5">
            <h3 class="card-title d-flex">Web App Icons</h3>
            <v-row>
              <v-col cols="12" sm="4" class="my-1">
        ...
        <v-card class="mb-7">
          <v-card-text class="pa-5">
            <h3 class="card-title d-flex">Control Icons</h3>
            <v-row>
              <v-col cols="12" sm="4" class="my-1">
              ...
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-control-skip-forward"></i> ti-control-skip-forward
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-control-skip-backward"></i> ti-control-skip-backward
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
        ...
        <v-card class="mb-7">
          <v-card-text class="pa-5">
            <h3 class="card-title d-flex">Text Editor Icons</h3>
            <v-row>
              <v-col cols="12" sm="4" class="my-1">
        ...
        <v-card class="mb-7">
          <v-card-text class="pa-5">
            <h3 class="card-title d-flex">Layout Icons</h3>
            <v-row>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-width-full"></i> ti-layout-width-full
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-width-default"></i> ti-layout-width-default
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-width-default-alt"></i> ti-layout-width-default-alt
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
              ...
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-sidebar-right"></i> ti-layout-sidebar-right
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-sidebar-none"></i> ti-layout-sidebar-none
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-sidebar-left"></i> ti-layout-sidebar-left
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
              ...
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-menu-separated"></i> ti-layout-menu-separated
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
              ...
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-media-right-alt"></i> ti-layout-media-right-alt
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-media-overlay"></i> ti-layout-media-overlay
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-media-overlay-alt"></i> ti-layout-media-overlay-alt
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-media-overlay-alt-2"></i> ti-layout-media-overlay-alt-2
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-media-left"></i> ti-layout-media-left
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-media-left-alt"></i> ti-layout-media-left-alt
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-media-center"></i> ti-layout-media-center
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-media-center-alt"></i> ti-layout-media-center-alt
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-list-thumb"></i> ti-layout-list-thumb
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-list-thumb-alt"></i> ti-layout-list-thumb-alt
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-list-post"></i> ti-layout-list-post
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-list-large-image"></i> ti-layout-list-large-image
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
              ...
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-cta-btn-right"></i> ti-layout-cta-btn-right
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-cta-btn-left"></i> ti-layout-cta-btn-left
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
              ...
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-accordion-separated"></i> ti-layout-accordion-separated
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-accordion-merged"></i> ti-layout-accordion-merged
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-layout-accordion-list"></i> ti-layout-accordion-list
              </v-col>
              <v-col cols="12" sm="4" class="my-1">
        ...
        <v-card class="mb-7">
          <v-card-text class="pa-5">
            <h3 class="card-title d-flex">Brand Icons</h3>
            <v-row>
              <v-col cols="12" sm="4" class="my-1">
              ...
              <v-col cols="12" sm="4" class="my-1">
                <i class="mr-2 ti-themify-favicon-alt"></i> ti-themify-favicon-alt
              </v-col>
            </v-row>
          </v-card-text>
        </v-card>
