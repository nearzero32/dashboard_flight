...
<template>
  ...
  <div>
    <v-list-item-subtitle class="text-wrap">
      The
      <code>v-data-iterator</code> has internal state for both selection and expansion, just like
      <code>v-data-table</code>. In this example we use the methods
      <code>isExpanded</code> and
      <code>expand</code> available on the default slot.
