...
<template>
  ...
  <div>
    <v-list-item-subtitle class="text-wrap">
      The <code>v-data-iterator</code> has both a header and footer slot for
        ...
        <template v-slot:default="props">
          <v-row>
            ...
            >
              <v-card>
                <v-card-title
                  class="subheading font-weight-medium text-truncate"
        ...
        <template v-slot:footer>
          <v-toolbar class="mt-2" color="primary" dark flat>
            <v-toolbar-title class="subheading"
              >This is a footer</v-toolbar-title
            >
          </v-toolbar>
        </template>
      </v-data-iterator>
