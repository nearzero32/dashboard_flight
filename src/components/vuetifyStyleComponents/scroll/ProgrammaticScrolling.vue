...
<template>
    ...
    <div>
        ...
        The <code>goTo</code> method takes two parameters <code>target</code> and <code>options</code>. <code>target</code> can be either a pixel offset from the top of the page, a valid css selector, or an element reference. options is an object that includes <code>duration</code>, <code>easing</code> ,<code>container</code>, and <code>offset</code>.
