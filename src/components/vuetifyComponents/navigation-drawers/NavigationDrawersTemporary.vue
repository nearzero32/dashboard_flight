...
<template>
  ...
  <div>
    <v-list-item-subtitle class="text-wrap">
      ...
      to darken the background. This drawer behavior is mimicked by default when
      on mobile. Clicking outside of the drawer will cause it to close.
...
<script>
export default {
  name: "NavigationDrawersTemporary",
