...
<template>
  ...
  <div>
    <v-list-item-subtitle class="text-wrap">
      Using the
      <span class="grey--text text--darken-4 font-weight-bold">bottom</span>
      prop, we are able to relocate our drawer on mobile devices to come from
      the bottom of the screen. This is an alternative style and only activates
      once the
      <span class="grey--text text--darken-4 font-weight-bold"
        >mobile-break-point</span
      >
      is met.
