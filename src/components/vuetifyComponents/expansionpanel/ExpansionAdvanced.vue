...
<template>
    ...
    <div>
       <v-list-item-subtitle class="text-wrap">
        The expansion panel component provides a rich playground to build truly advanced implementations. Here we take advantage of slots in the <code>v-expansion-panel-header</code> component to react to the state of being open or closed by fading content in and out.
