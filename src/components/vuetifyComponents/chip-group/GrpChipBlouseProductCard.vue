...
<template>
  ...
  <div>
    <v-list-item-subtitle class="text-wrap">
      The <code>v-chip</code> component can have an explicit value used for its
      model. This gets passed to the <code>v-chip-group</code> component and is
      useful for when you don't want to use the chips index as their values.
    ...
    <div class="mt-4">
      <v-card class="mx-auto" max-width="400">
        ...
        <v-card-text>
          ...
          <v-chip-group v-model="selection" active-class="info--text" mandatory>
