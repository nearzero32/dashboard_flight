...
<template>
    ...
    <div>
        ...
        <code>dense</code> timelines position all content to the right. In this example, <code>v-alert</code> replaces the card to provide a different design.
