...
<template>
    ...
    <div>
        ...
        The <code>v-rating</code> component fits right in with existing components. Build truly complex examples with rich features and beautiful designs.
